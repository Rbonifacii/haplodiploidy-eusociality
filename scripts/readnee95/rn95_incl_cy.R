...
# - This script uses the "inclusive" definition of Haplodiploidy, and Crespi & Yanega's (1995) definition of eusociality
# ==============================================================================
...
write.csv(contrasts_df, here("output", "read_nee_contrasts.csv"), row.names = FALSE)
...
write.csv(contrast_results, here("output", "read_nee_results_summary.csv"), row.names = FALSE)
...
write.csv(eusocial_results, here("output", "read_nee_robustness_incl_cy.csv"), row.names = FALSE)
