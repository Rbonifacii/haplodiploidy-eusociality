...
# - This script uses the "strict" definition of Haplodiploidy, and Michener/Wilson's "Eusociality" definition 
# ==============================================================================
...
write.csv(contrast_results, here("output", "read_nee_results_str_mw.csv"), row.names = FALSE)
...
write.csv(eusocial_results, here("output", "read_nee_robustness_str_mw.csv"), row.names = FALSE)
