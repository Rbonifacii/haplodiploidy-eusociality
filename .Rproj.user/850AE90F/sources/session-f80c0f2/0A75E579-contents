...
# haplodiploid clades show higher prevalence of eusociality than their non-haplodiploid sister clades. 
...
# - This script uses the "inclusive" definition of Haplodiploidy, and Boomsma & Gawnes "Superorganism" definition 
# ==============================================================================
...
write.csv(contrast_results, here("output", "read_nee_results_incl_bg.csv"), row.names = FALSE)
...
write.csv(eusocial_results, here("output", "read_nee_robustness_incl_bg.csv"), row.names = FALSE)
